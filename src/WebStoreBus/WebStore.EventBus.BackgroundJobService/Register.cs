...
namespace WebStore.EventBus.BackgroundJobService
{
    public static class Register
    {
        public static IServiceCollection AddBackgroundJobs(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddHangfire(config => config.UseSqlServerStorage(configuration.GetConnectionString("sqlString")));
        ...
        public static IHost RunBackgroundJobs(this IHost app)
        {
            app.Services
                ...
                .AddOrUpdate<IBackgroundJobProcesser>("background-job", instance => instance.ProcessEvents(), "0/1 * * * * *");
